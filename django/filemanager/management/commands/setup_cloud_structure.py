...
from publisher.settings import YADISK_TOKEN, YADISK_BASE_PATH, YADISK_MAILINGS_SEND_PROGRAM_PATH, YADISK_MAILINGS_BASE_PATH, YADISK_ORIGINALS_THESIS_PATH, YADISK_ORIGINALS_ARTICLE_PATH, YADISK_THESIS_PATH, YADISK_ARTICLE_PATH, YADISK_ORIGINALS_DIR
